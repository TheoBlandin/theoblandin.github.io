      ...
      <Container className="w-full">
        <Row justify="between">
          <Col lg={3} xxl={2} className="col-footer flex flex-col first-col">
            ...
            <Link to="/legals" className="bottom-link"><span>Mentions légales</span></Link>
          </Col>
          <Col lg={3} xxl={2} className="col-footer flex flex-col">
            <a href="https://www.linkedin.com/in/th%C3%A9o-blandin/"
              aria-label="Visitez mon profil LinkedIn" target="_blank" rel="noopener noreferrer" className="bottom-link">
            ...
            <a href="/assets/CV_Theo_Blandin.pdf" aria-label="Visualiser mon CV"
              target="_blank" rel="noopener noreferrer" className="bottom-link">
              <div className="flex flex-row items-center gap-2">
